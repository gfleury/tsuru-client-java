...
public class TsuruApi implements Serializable {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call appDeployCall(String name, File file, String image, String message, String commit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call appDeployValidateBeforeCall(String name, File file, String image, String message, String commit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
...
//        }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public String appDeploy(String name, File file, String image, String message, String commit) throws ApiException {
        ApiResponse<String> resp = appDeployWithHttpInfo(name, file, image, message, commit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<String> appDeployWithHttpInfo(String name, File file, String image, String message, String commit) throws ApiException {
        com.squareup.okhttp.Call call = appDeployValidateBeforeCall(name, file, image, message, commit,null, null);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call appDeployAsync(String name, File file, String image, String message, String commit, final ApiCallback<String> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = appDeployValidateBeforeCall(name, file, image, message, commit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<String>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call appDeployListCall(String appName, int limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/1.0/deploys";

        List<Pair> localVarQueryParams = new ArrayList<Pair>();

        if (appName != null)
            localVarQueryParams.addAll(apiClient.parameterToPairs("", "app", appName));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call appDeployListValidateBeforeCall(String appName, int limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {

        com.squareup.okhttp.Call call = appDeployListCall(appName, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<Deployments> appDeployList(String appName, int limit) throws ApiException {
        ApiResponse<List<Deployments>> resp = appDeployListWithHttpInfo(appName, limit);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<Deployments>> appDeployListWithHttpInfo(String appName, int limit) throws ApiException {
        com.squareup.okhttp.Call call = appDeployListValidateBeforeCall(appName, limit,null, null);
        Type localVarReturnType = new TypeToken<List<Deployments>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call appDeployListAsync(String appName, int limit, final ApiCallback<List<Deployments>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = appDeployListValidateBeforeCall(appName, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<Deployments>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
